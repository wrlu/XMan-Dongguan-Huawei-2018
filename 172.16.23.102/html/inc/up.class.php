...
var $accessPath ;
var $fileSize=4000;
var $defineTypeList="php|php3|php4|php5";//string jpg|gif|bmp  ...
...
function CheckFileAttri_size()
{
 ...
 {
  $newFileName = NULL;
  $newFileName = $this -> ChangeFileName( $this -> filePrefix , 2 ). "." . $this -> GetFileType();
...
function CheckFileMIMEType()
 ...
 {
   return pathinfo( $this -> uploadFile[ 'name' ])['extension'];
 }
}
?>